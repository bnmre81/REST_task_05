...
from .serializers import FlightSerializer, BookingSerializer, BookingDetailsSerializer, UpdateBookingSerializer, RegisterSerializer, UpdateBookingSerializerUser
...
class UpdateBooking(RetrieveUpdateAPIView):
	...
	def get_serializer_class(self):
		if self.request.user.is_staff:
			...
			return UpdateBookingSerializerUser
